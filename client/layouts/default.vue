    ...
    >
      <template class="d-flex align-center">
        ...
        <div class="d-flex align-center ml-2">
          <p v-if="user" class ="d-flex my-auto font-weight-medium text-capitalize d-none d-md-block primary--text text-h5">Welcome, <span class="accent--text pl-2">{{user.firstName}}</span></p>
        </div>
      </template>
